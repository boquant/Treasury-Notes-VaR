...
Backtested on data from 1990 - 2025, stressed VaR reduces exceptions by 50 percents and passes both unconditional test and independence test. Applied PCA to exceptions and calculated dot products of exceptions dy and first 3 PCs as a measure of dy movements, concluded VaR exceptions were mainly caused by great shift in first PC (level) and stressed VaR can capture these single PC movements but fails when there is combination movement.
